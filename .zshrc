...
fft() {
  local dir
  dir=$(find /Users/aure/Desktop/des -type d 2> /dev/null | fzf) && cd "$dir" && tmux new-session -A -s "$(basename "$dir")"
}

ffa() {
  local dir
  dir=$(find /Users/aure/ -type d 2> /dev/null | fzf) && cd "$dir" 
}


# pnpm
export PNPM_HOME="/Users/aure/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
...
export PATH="$PATH:/Users/aure/.local/bin"
